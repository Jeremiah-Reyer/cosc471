...
<head>
	...
	<title>Delete Production Company</title>
	<style>
...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Production Company</h1>
	
	<form action="deleteProductionCompany.php" method="post">

	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Production Company<br></p>
			<input name = pc_name required type = "text" placeholder = "Name"><br>
      <input type = "submit" value = "GO" name = "deleteProductionCompany" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteProductionCompany']))
{
	//get input data
	$name = $_POST['pc_name'];
	...
	//delete data
	$sql = "DELETE FROM Production_company
	WHERE name='$name'";
