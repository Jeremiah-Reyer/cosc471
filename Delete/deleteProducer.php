...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Producer</h1>
	
	<form action="deleteProducer.php" method="post">

	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Producer<br></p>
			<input name = p_name required type = "text" placeholder = "Name"><br>
      <input type = "submit" value = "GO" name = "deleteProducer" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteProducer']))
{
	//get input data
	$name = $_POST['p_name'];
