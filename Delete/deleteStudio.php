...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Studio</h1>
	
	<form action="deleteStudio.php" method="post">

	<div style="float:left;  margin-left: 5px; margin-right: 5px">
			<p>Studio<br></p>
			<input name = studioName required type = "text" placeholder = "Name"><br>
      <input type = "submit" value = "GO" name = "deleteStudio" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteStudio']))
{
	//get input data
