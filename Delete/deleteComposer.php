...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Composer</h1>
	
	<form action="deleteComposer.php" method="post">

	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Composer<br></p>
			<input name = c_name required type = "text" placeholder = "Name"><br>
      <input type = "submit" value = "GO" name = "deleteComposer" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteComposer']))
  {
	//get input data
	$name = $_POST['c_name'];
