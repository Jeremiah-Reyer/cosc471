...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Theater</h1>
	
	<form action="deleteTheater.php" method = "post">
	...
	<div style= "position:absolute; margin-left: 5px; margin-bottom: 5px">
			...
			<input type = "submit" value = "GO" name = "deleteTheater" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteTheater']))
{
	//get input data
	$name = $_POST['t_name'];
