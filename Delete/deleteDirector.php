...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Delete Director</h1>
	
	<form action="deleteDirector.php" method="post">

	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Director<br></p>
			<input name = d_name required type = "text" placeholder = "Name"><br>
      <input type = "submit" value = "GO" name = "deleteDirector" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['deleteDirector']))
{
	//get input data
	$name = $_POST['a_name'];
