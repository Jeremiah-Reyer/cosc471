...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<div style="float:left;  margin-left: 5px; margin-right: 5px">
      ...
      <input type = "submit" value = "GO" name = "addStudio" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addStudio']))
  {
	//get input data
	...
	VALUES ('$name','$moviesfunded','$setlocations','$hq','$moviespublished','$founder','$month','$year')";
