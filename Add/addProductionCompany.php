...
<head>
	...
	<title>Add Production Company</title>
	<style>
...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Add Production Company</h1>
	
	<form action = "addProductionCompany.php" method="post">
	...
	<div style="float:left; margin-left: 5px; margin-right: 5px">
      ...
      <input type = "submit" value = "GO" name = "addProductionCompany" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addProductionCompany']))
  {
	//get input data
	$name = $_POST['pc_name'];
	...
	VALUES ('$name','$president','$founder','$month','$day','$year','$city','$state','$locations')";
