...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Add Screen Writer</h1>
	
	<form action="addScreenWriter.php" method="post">
	...
	<div style= "position:absolute; margin-left: 5px; margin-bottom: 5px">
			...
			<input type = "submit" value = "GO" name = "addScreenWriter" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addScreenWriter']))
  {
	//get input data
	$name = $_POST['s_name'];
	$age = $_POST['s_age'];
	...
	VALUES ('$name','$age','$month','$year','$day','$sex')";
