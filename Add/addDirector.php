...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<div style="float:left; margin-left: 5px; margin-right: 5px">
      ...
      <input type = "submit" value = "GO" name = "addDirector" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addDirector']))
  {
	//get input data
	$name = $_POST['d_name'];
	$age = $_POST['d_age'];
	...
	VALUES ('$name','$age','$month','$year','$day','$sex','$award')";
