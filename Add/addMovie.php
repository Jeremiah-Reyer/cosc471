...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Actor<br></p>
			<input name = a_name required type = "text" placeholder = "Name"><br>
	...
	<div style="float:left; margin-left: 5px; margin-right: 5px">
			<p>Director<br></p>
			<input name = d_name required type = "text" placeholder = "Name"><br>
	...
	<div style= "position:absolute; margin-left: 5px; margin-top:250px; margin-bottom: 5px">
			...
			<input type = "submit" value = "GO" name = "addMovie" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addMovie']))
  {
	...
	//SCREEN_WRITER
		...
		{			
			//insert data
			$sql = "INSERT INTO Screen_writer (name, age, month, year, day, sex)
	...
	//finally create movie table entry
	...
	$sql = "INSERT INTO Movie (name, profit, genre, runtime, cost, director, producer,
			production_company, composer, screen_writer, actor, studio, score)
	VALUES ('$m_name','$profit','$genre','$runtime','$cost','$d_name','$p_name',
			'$pc_name','$c_name','$s_name','$a_name','$s_name','$score')";
