...
<p style="float:right"><a href="../Search/advancedSearch.php">Advanced Search</a></p>
	...
	<h1 class = "name">Add Critic</h1>
	
	<form action = "addCritic.php" method = "post">
	...
	<div style= "position:absolute; margin-left: 5px; margin-bottom: 5px">
			...
			<input type = "submit" value = "GO" name = "addCritic" />
...
<?php
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addCritic']))
  {
	//get input data
	$name = $_POST['c_name'];
	$age = $_POST['c_age'];
	...
	$year = $_POST['c_byear'];
	$day = $_POST['c_bday'];
	$movies_reviewed = $_POST['movies_reviewed'];
	...
	//insert data
	$sql = "INSERT INTO Critic (name, age, month, year, day, Movies_reviewed)
	VALUES ('$name','$age','$month','$year','$day','$movies_reviewed')";
